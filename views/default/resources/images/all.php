...
$content = elgg_view('lists/images/all', ['owner_guids' => $owner_guid, 'container_guids' => $target_guid]);
if (elgg_is_xhr()) {
    echo $content;
} else {
    $body = elgg_view_layout('content', ['content' => $content, 'title' => $title, 'filter' => elgg_view('filters/images/all', ['filter_context' => $filter_context])]);
