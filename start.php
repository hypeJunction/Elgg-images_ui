...
{
    elgg_register_menu_item('site', ['name' => 'images', 'text' => elgg_echo('images'), 'href' => '/images/all']);
    ...
    elgg_register_route('images', ['path' => '/images/{segments}', 'resource' => 'images', 'requirements' => ['segments' => '.+'], 'defaults' => ['segments' => '']]);
...
function images_ui_page_handler($segments, $identifier)
{
    ...
    switch ($page) {
        ...
        case 'list':
        case 'group':
            echo elgg_view("resources/images/all", ['target_guid' => $segments[0], 'identifier' => $identifier]);
            return true;
        case 'owner':
            $username = $segments[0];
            ...
            echo elgg_view("resources/images/all", ['target_guid' => $user->guid, 'identifier' => $identifier]);
            return true;
        case 'friends':
            echo elgg_view("resources/images/friends", ['username' => $segments[0], 'identifier' => $identifier]);
            return true;
        case 'groups':
            echo elgg_view("resources/images/groups", ['username' => $segments[0], 'identifier' => $identifier]);
            return true;
        case 'add':
        case 'upload':
            echo elgg_view("resources/images/upload", ['container_guid' => $segments[0], 'identifier' => $identifier]);
            return true;
        case 'edit':
            echo elgg_view("resources/images/edit", ['guid' => $segments[0], 'identifier' => $identifier]);
            return true;
        case 'view':
            echo elgg_view("resources/images/view", ['guid' => $segments[0], 'identifier' => $identifier]);
            return true;
    }
    return false;
}